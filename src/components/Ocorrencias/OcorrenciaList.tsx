...
import { Search, Filter, FileText, Eye, ArrowUpDown } from 'lucide-react';
      ...
      <CardContent>
        ...
        <div className="mb-6 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="relative">
            ...
            <Input
              placeholder="Buscar por número, local ou descrição..."
              value={searchTerm}
        ...
        <div className="space-y-4">
          {filteredOcorrencias.length > 0 ? (
            filteredOcorrencias.map((ocorrencia) => (
              <div key={ocorrencia.id} className="border rounded-lg p-4 hover:bg-gray-50 transition-colors">
