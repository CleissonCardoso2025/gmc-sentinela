    ...
    try {
      ...
      if (!googleMapRef.current) {
        ...
        window.google.maps.event.addListener(googleMapRef.current, 'idle', () => {
          console.log("Occurrence map is fully loaded and idle");
      ...
      console.error("Error initializing occurrence map:", error);
      setMapError("Falha ao inicializar o mapa de ocorrências");
    }
